...
export default function TaskManager() {
    ...
    const postTask = async (newTask) => {
        await axios.post("http://192.168.1.126:3000/task", newTask).then(
            function (res) {
                console.log(res);
    ...
    const fetchTypes = async () => {
        await axios.get("http://192.168.1.126:3000/types").then(
            function (res) {
    ...
    const fetchCustomers = async () => {
        await axios.get("http://192.168.1.126:3000/customers").then(
            function (res) {
                console.log(res.data);
    ...
    const fetchStatuses = async () => {
        await axios.get("http://192.168.1.126:3000/statuses").then(
            function (res) {
                console.log(res.data);
    ...
    const fetchTags = async () => {
        axios.get("http://192.168.1.126:3000/tags").then(
            function (res) {
                console.log(res.data);
                setTags(res.data);
            })
